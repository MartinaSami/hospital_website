...
!(function() {
    ...
    ((DateFormatter = function(e) {
        ...
        parseDate: function(e, t) {
            ...
            for (
                n = e.replace(c.separators, "\0").split("\0"), r = 0; r < n.length; r++
            )
                        ...
                        ((o = l.children().eq(0)),
                            ...
                            .on("scroll_element.xdsoft_scroller", function(e, t) {
                                i || l.trigger("resize_scroll.xdsoft_scroller", [t, !0]),
                                    ...
                                    setTimeout(function() {
                                        o.css(
                                            "marginTop", -parseInt((o[0].offsetHeight - i) * t, 10)
                                        );
                                    }, 10);
                            })
                            .on("resize_scroll.xdsoft_scroller", function(e, t, a) {
                                ...
                                1 < n ?
                                    ...
                                    (u.show(),
                                        ...
                                        (f = d[0].offsetHeight - u[0].offsetHeight), !0 !== a &&
            ...
            return (
                (n = function(O) {
                    ...
                    function c(m) {
                        ...
                        m.mask && O.off("keydown.xdsoft"), !0 === m.mask &&
                            (E.formatMask ?
                    ...
                    F.find(".xdsoft_select")
                        ...
                        _.data("options", N).on("touchstart mousedown.xdsoft", function(
                            e
                        ) {
                            return (
                        ...
                        _.append(g).append(o), !0 !== N.withoutCopyright && _.append(e),
                                ...
                                (t = setTimeout(function() {
                                    ...
                                    for (
                                        ...
                                        (u =
                                            ...
                                            D.getDate()); c < W.currentTime.countDaysInMonth() ||
                                        ...
                                        ((!1 !== h && h < f) ||
                                            ...
                                            (!1 !== D && u < k) ||
                                            (i && !1 === i[0])) &&
                                        y.push("xdsoft_disabled"), -1 !==
                                            N.disabledDates.indexOf(
                                                E.formatDate(f, N.formatDate)
                                            ) && y.push("xdsoft_disabled"), -1 !== N.disabledWeekDays.indexOf(a) &&
                                            y.push("xdsoft_disabled"),
                                    ...
                                    for (
                                        P.html(b), H = "", c = parseInt(N.yearStart, 10); c <= parseInt(N.yearEnd, 10); c += 1
                                    )
                                        H +=
                            ...
                            return (!N.scrollInput ||
                                (!N.datepicker && N.timepicker ?
                                    (0 <=
                                        ...
                                        P.children().eq(a).trigger("mousedown"), !1) :
                                    N.datepicker && !N.timepicker ?
                                    (g.trigger(e, [e.deltaY, e.deltaX, e.deltaY]),
                                        O.val && O.val(W.str()),
                                        _.trigger("changedatetime.xdsoft"), !1) :
                                    void 0)
                            );
                        }),
                        ...
                        _.on("open.xdsoft", function(e) {
                            ...
                            N.onShow &&
                                ...
                                (t = N.onShow.call(_, W.currentTime, _.data("input"), e)), !1 !== t &&
                                (_.show(),
                                    r(),
                                    L(N.contentWindow)
                                    .off("resize.xdsoft", r)
                        ...
                        .on("close.xdsoft", function(e) {
                            ...
                            F.find(".xdsoft_month,.xdsoft_year")
                                ...
                                (t = N.onClose.call(_, W.currentTime, _.data("input"), e)), !1 === t || N.opened || N.inline || _.hide(),
                                e.stopPropagation();
                        })
